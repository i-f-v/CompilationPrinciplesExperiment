...
public class MIDLParser extends Parser {
    ...
    public static class MemberContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MIDLParserVisitor)
                return ((MIDLParserVisitor<? extends T>) visitor).visitMember(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Or_exprContext extends ParserRuleContext {
        ...
        public TerminalNode OR() {
            return getToken(MIDLParser.OR, 0);
        }
    ...
    public static class Xor_exprContext extends ParserRuleContext {
        ...
        public TerminalNode POWER() {
            return getToken(MIDLParser.POWER, 0);
        }
    ...
    public static class And_exprContext extends ParserRuleContext {
        ...
        public TerminalNode AMP() {
            return getToken(MIDLParser.AMP, 0);
        }
    ...
    public static class Shift_exprContext extends ParserRuleContext {
        ...
        public TerminalNode GT2() {
            return getToken(MIDLParser.GT2, 0);
        }

        public TerminalNode LT2() {
            return getToken(MIDLParser.LT2, 0);
        }
    ...
    public static class Multi_exprContext extends ParserRuleContext {
        ...
        public TerminalNode STAR() {
            return getToken(MIDLParser.STAR, 0);
        }

        public TerminalNode SLASH() {
            return getToken(MIDLParser.SLASH, 0);
        }

        public TerminalNode PERCENT() {
            return getToken(MIDLParser.PERCENT, 0);
        }
    ...
    public static class Unsigned_intContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MIDLParserVisitor)
                return ((MIDLParserVisitor<? extends T>) visitor).visitUnsigned_int(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Signed_intContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MIDLParserVisitor)
                return ((MIDLParserVisitor<? extends T>) visitor).visitSigned_int(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Float_pt_typeContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MIDLParserVisitor)
                return ((MIDLParserVisitor<? extends T>) visitor).visitFloat_pt_type(this);
            else return visitor.visitChildren(this);
        }
    }
